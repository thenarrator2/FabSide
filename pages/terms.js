      ...
      <div class="translations-content-container">
        <div class="container p-3">
          <div class="tab-content translations-content-item en visible" id="en">
            ...
            <p className="py-1">Last updated: July 30, 2023</p>
            <p className="py-1">
              Please read these terms and conditions carefully before using Our
              Service.
            </p>
            <h1 className="text-4xl font-bold mb-1 py-3">
              Interpretation and Definitions
            </h1>
            <h2 className="text-3xl font-bold py-2 ">Interpretation</h2>
            <p className="py-1">
            ...
            <h2 className="text-3xl font-bold py-2 ">Definitions</h2>
            <p className="py-1">
            ...
            <ul>
              ...
              <li>
                <p className="py-1">
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to FabSide.
                </p>
              </li>
              <li>
                <p className="py-1">
              ...
              <li>
                <p className="py-1">
                  <strong>Website</strong> refers to FabSide, accessible from{" "}
                  <a
                    href="http://www.fabside.com"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    http://www.fabside.com
                  </a>
                </p>
              </li>
              <li>
            ...
            <h1 className="text-3xl font-bold py-2 ">Acknowledgment</h1>
            <p className="py-1">
            ...
            <h1 className="text-3xl font-bold py-2 ">Termination</h1>
            <p className="py-1">
            ...
            <h1 className="text-3xl font-bold py-2 ">Governing Law</h1>
            <p className="py-1">
            ...
            <h1 className="text-3xl font-bold py-2 ">Disputes Resolution</h1>
            <p className="py-1">
            ...
            <h2 className="text-2xl font-bold py-2 ">Severability</h2>
            <p className="py-1">
            ...
            <h2 className="text-2xl font-bold py-2 ">Waiver</h2>
            <p className="py-1">
            ...
            <ul>
              <li>
                By email:<strong>rajivsoren76@gmail.com</strong>
              </li>
            </ul>
          </div>
        </div>
