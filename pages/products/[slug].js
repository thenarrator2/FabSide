  ...
  const getpay = async () => {
    ...
    try {
      ...
      const resp = await fcContractWithSigner.depositTokens(
        BigInt(product.lyt * 1000000000000000000)
      );
      console.log(resp);
          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                {product.availableQty > 0 && (
                  <span className="title-font font-medium flex text-2xl px-2 text-gray-900">
                    <MdGeneratingTokens className="mx-1 my-2 " />
                    {product.lyt}
                  </span>
                )}
                {product.availableQty <= 0 && (
              ...
              {/* <div className="flex my-2 ">
                <button
                  disabled={product.availableQty <= 0}
                  onClick={getpay}
                  className="disabled:bg-pink-300 flex ml-8 text-white bg-pink-500 border-0 py-2 px-6 md:px-6 focus:outline-none hover:bg-pink-600 rounded"
                >
                  Buy With Token
                </button>
              </div> */}
