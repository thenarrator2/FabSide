      ...
      <div class="translations-content-container">
        <div class="container p-3">
          <div class="tab-content translations-content-item en visible" id="en">
            ...
            <p>Thank you for shopping at FabSide.</p>
            <p className="py-2">
            ...
            <h1 className="text-4xl font-bold mb-1 py-2 ">
              Interpretation and Definitions
            </h1>
            <h2 className="text-3xl font-bold py-3">Interpretation</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold py-3">Definitions</h2>
            ...
            <h1 className="text-3xl font-bold py-3">Conditions for Returns</h1>
            <p>
            ...
            <h1 className="text-1xl font-bold py-3">Gifts</h1>
            <p>
            ...
            <h2 className="text-1xl font-bold py-3">Contact Us</h2>
            <p>
