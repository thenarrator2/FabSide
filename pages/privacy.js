    ...
    <div>
      <div class="translations-content-container">
        <div class="container p-3">
          ...
          <p className="py-1">For the purposes of this Privacy Policy:</p>
          <ul>
            <li>
              <p className="py-1">
            ...
            <li>
              <p className="py-1">
                ...
                in this Agreement) refers to FabSide.
              </p>
            </li>
            <li>
              <p className="py-1">
          ...
          <h2 className="text-2xl font-bold py-2">Types of Data Collected</h2>
          <h3 className="text-2xl font-bold py-2">Personal Data</h3>
          <p className="py-1">
          ...
          <ul>
            <li>
              <p className="py-1">Email address</p>
            </li>
            <li>
              <p className="py-1">First name and last name</p>
            </li>
            <li>
            ...
            <li>
              <p className="py-1">Usage Data</p>
            </li>
          </ul>
          <h3 className="text-2xl font-bold py-2">Usage Data</h3>
          <p className="py-1">
          ...
          <ul>
            <li>
              ...
              <p className="py-1">Type: Session Cookies</p>
              <p className="py-1">Administered by: Us</p>
              <p className="py-1">
            ...
            <li>
              ...
              <p className="py-1">Type: Persistent Cookies</p>
              <p className="py-1">Administered by: Us</p>
              <p className="py-1">
          ...
          <h2 className="text-2xl font-bold py-2">Use of Your Personal Data</h2>
          <p className="py-1">
          ...
          <h2 className="text-2xl font-bold py-2">Delete Your Personal Data</h2>
          <p className="py-1">
          ...
          <h3 className="text-2xl font-bold py-2">Business Transactions</h3>
          <p className="py-1">
          ...
          <h3 className="text-2xl font-bold py-2">Law enforcement</h3>
          <p className="py-1">
          ...
          <h3 className="text-2xl font-bold py-2">Other legal requirements</h3>
          <p className="py-1">
          ...
          <h1 className="text-3xl font-bold py-2">Children's Privacy</h1>
          <p className="py-1">
          ...
          <h1 className="text-3xl font-bold py-2">Links to Other Websites</h1>
          <p className="py-1">
